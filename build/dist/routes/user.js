...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error, _a, username, password, email, image, userInDb, e_1, salt, passwordHash, user, result, _id, e_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4: return [4 /*yield*/, bcryptjs_1.default.genSalt()];
            case 5:
                salt = _b.sent();
            ...
            case 8:
                result = _b.sent();
                _id = result._id;
                return [2 /*return*/, res.status(200).send({ id: _id })];
            case 9:
                e_2 = _b.sent();
                console.log(e_2);
                return [2 /*return*/, res.status(500).send("Internal Error")];
